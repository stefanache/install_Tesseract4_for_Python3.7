...
Remark:
          ...
          With pdf2image(based on poppler) installed can create one similar code like in:
          
                  #c:\tesseract-python\pdf_to_image_ocr.py
                  # take sample2.pdf and create 2 images : page1.jpg and page.jpg
                  # these images will be parsed with c:\tesseract-python\image_example.py(where change only file)
